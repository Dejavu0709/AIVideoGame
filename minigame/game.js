...
const managerConfig = {
    DATA_FILE_MD5: '102cd465812da77d',
    CODE_FILE_MD5: 'c3fc4439534cc204',
    GAME_NAME: 'webgl',
    APPID: 'wx7643b5a4fdea3424',
    DATA_FILE_SIZE: '17450982',
    OPT_DATA_FILE_SIZE: '$OPT_DATA_FILE_SIZE',
    DATA_CDN: 'https://636c-cloud1-7gwlsz5m226cfca9-1369289063.tcb.qcloud.la/AIVideoGame/',
    // 资源包是否作为小游戏分包加载
