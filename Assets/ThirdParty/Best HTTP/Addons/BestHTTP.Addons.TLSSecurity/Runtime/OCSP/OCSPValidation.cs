...
namespace BestHTTP.Addons.TLSSecurity.OCSP
{
    ...
    {
        public static void Validate(List<X509Certificate> chain, SecureProtocol.Org.BouncyCastle.Tls.CertificateStatus certificateStatus, BestHTTP.Logger.LoggingContext loggingContext)
        {
            if (chain.Count < 2)
        ...
        public static SingleResponse GetOCSPResponse(BestHTTP.SecureProtocol.Org.BouncyCastle.Tls.CertificateStatus certificateStatus, List<X509Certificate> chain, BestHTTP.Logger.LoggingContext loggingContext)
        {
        ...
        public static void ValidateIssuerWithOCSP(SingleResponse singleResponse, X509Certificate leaf, X509Certificate issuerCertificate, BestHTTP.Logger.LoggingContext loggingContext)
        {
