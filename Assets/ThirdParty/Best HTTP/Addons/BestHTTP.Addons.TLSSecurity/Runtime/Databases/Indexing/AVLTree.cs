...
namespace BestHTTP.Addons.TLSSecurity.Databases.Indexing
{
    public enum Side
    {
        Left,
    ...
    public sealed class Node<KeyT, ValueT>
    {
        ...
        public int Depth;///*{ get; private set; } //*/{ get { return Math.Max(this.LeftDepth, this.RightDepth) + 1; } }
    ...
    public sealed class AVLTree<Key, Value>
    {
        ...
        public bool TestBalance() => TestBalance(this.root);
