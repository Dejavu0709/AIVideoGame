...
namespace BestHTTP.Addons.TLSSecurity.Editor
{
    ...
    public sealed class ClientCredentialsSetupBinding : ScriptableObject
    {
        ...
        public string HelpURL = "https://benedicht.github.io/BestHTTP-Documentation/#8.Addons/TLSSecurity/CertificationManagerWindow/#client-certificates";
    }
    ...
    public sealed class ClientCredentialsManager : IPasswordFinder
    {
        ...
        public ClientCredentialsManager(VisualElement credentialsRoot, ClientCredentialDatabase credentialDatabase)
        {
        ...
        void OnTLSecuritySetupFinished()
        {
            ...
            this.template = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(EditorHelper.GetRelativePluginFolder() + "/Editor/UXML/ClientCredentialItemTemplate.uxml");
        ...
        private void ReadPEM(string selectedFile, string targetDomain)
        {
            ...
            {
                var reader = new SecureProtocol.Org.BouncyCastle.OpenSsl.PemReader(stream, this);
                object obj = null;
