...
using BestHTTP.Addons.TLSSecurity.CSV;
...
namespace BestHTTP.Addons.TLSSecurity.Editor
{
    ...
    public sealed class TemplateHandler
    {
        ...
        public TemplateHandler(VisualElement templateRoot, TemplateBinding templateBinding, X509Database x509Database)
        {
        ...
        void OnTLSecuritySetupFinished()
        {
            ...
            this.itemTemplate = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(EditorHelper.GetRelativePluginFolder() + "/Editor/UXML/CertificationItemTemplate.uxml");
        ...
        private void OnDownloadClicked()
        {
                    ...
                    case HTTPRequestStates.Finished:
                        if (resp.IsSuccess)
                        {
                            try
                            {
                                ...
                                var parser = new SecureProtocol.Org.BouncyCastle.X509.X509CertificateParser();
            ...
            request.OnDownloadProgress += (req, down, len) =>
            {
