...
namespace BestHTTP.Addons.TLSSecurity.Editor.Utils
{
    public class DomainAndFileSelectorPopup : EditorWindow
    {
        ...
        public void OnEnable()
        {
            ...
            // Import UXML
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(EditorHelper.GetRelativePluginFolder() + "/Editor/Utils/DomainAndFileSelector/DomainAndFileSelectorPopup.uxml");
